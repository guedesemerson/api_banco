...
modelo_transacao = api.model('Transação', {"Data": fields.DateTime(required = True, description='Data em dd/mm/yyyy'),
          "Hora": fields.DateTime(  required = True, description='Hora em HH:MM'),
...
modelo_Filtro = api.model('Filtro',{
    "Hora": fields.DateTime(  required = True, description='Hora em HH:MM'),
    "Data": fields.DateTime(required = True, description='Data em dd/mm/yyyy'),
    "Valor": fields.Float( required = True,description='Valor da transação em R$')
